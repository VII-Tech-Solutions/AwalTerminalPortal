...
@section('content')
    ...
    <div>
        <a style="font-size: 16px; line-height: 27px;font-family: 'Source Sans Pro', sans-serif; color: #011e41" href="{{env('APP_URL')}}/admin/elite-services/"> {{env('APP_URL')}}/admin/elite-services</a>
    </div>
@endsection
