...
@section('content')
    ...
    <div>
        <p style="font-size: 16px; line-height: 27px;font-family: 'Source Sans Pro', sans-serif; color: #011e41">Date: {{ Carbon\Carbon::createFromFormat('Y-m-d',$data[2])->format('d-mm-Y') }}</p>
    </div>
    <div>
