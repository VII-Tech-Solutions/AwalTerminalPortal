...
<head>
    ...
    <style type="text/css">
      ...
      */
        ...
        .main-content {
            /*background-color: white;padding: 25px 40px 42px 40px;border-radius: 10px;overflow: hidden;*/
        }
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" id="bodyTable">
        <tr>
            <td align="center" valign="top" id="bodyCell">
                <!-- BEGIN TEMPLATE // -->
                <table border="0" cellpadding="0" cellspacing="0" id="templateContainer" style="width: 600px;max-width: 100%;">
                    {{--                    <tr>--}}
