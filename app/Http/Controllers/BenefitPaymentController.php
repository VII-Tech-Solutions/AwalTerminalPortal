...
/**
 * Class BenefitPaymentController
 * @package App\Http\Controllers
 */
class BenefitPaymentController extends CustomController
{
    ...
    {
        GlobalHelpers::debugger("BenefitPaymentController@checkout", DebuggerLevels::INFO);
    ...
    function showResult($success, $error_message = null)
    {
        ...
        // get the order
        /** @var Order $order */
        $order = Order::where(Attributes::GATEWAY, PaymentGateways::BENEFIT)
            ->where(Attributes::STATUS, PaymentStatus::PENDING)
            ->where(Attributes::UID, $order_uid)
    ...
    function verify() {
        ...
        if (env("DEBUGGER_LOGS_ENABLED", false)) {
            GlobalHelpers::logRequest($this->request, "BenefitPaymentController@verify");
        }
